...
function PhotoUploadListPage(props) {
  return (
    <Fragment>
        ...
        <Container className="upload_list_section py-sm-5 py-3">
          <Row>
            <Col className="d-flex justify-content-center align-items-center">
              <div className="d-flex flex-column justify-content-center align-items-center uploded_section">
            ...
            <Col lg={9} className="upload_list_items p-3 d-sm-flex">
              ...
              >
                <div className="d-none d-sm-block">
                  ...
                  <div className="flex_center flex-column">
                    <Button className="btn btn_sm mb-2 mt-2">
                      Download HD
                    </Button>
                    <p className="d-none d-md-block">
...
export default PhotoUploadListPage;
